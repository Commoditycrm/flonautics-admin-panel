...
import { GET_PROJECTS_IN_ORGANIZATION } from '@/src/gql/organization/GET_PROJECTS_IN_ORG';
...
const OrganizationProjects = () => {
    ...
    useEffect(() => {
        if (data?.projects.length) {
            ...
            setTotalCount(data?.projectsAggregate?.count)
        }
    }, [data])
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "assignedUsers",
            render: (assignedUsers: string) => assignedUsers.length,
        }
    ];
