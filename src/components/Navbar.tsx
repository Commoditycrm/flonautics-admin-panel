...
const Navbar = () => {
    ...
    const popoverContent = (
        <Row className="pt-2 pb-0">
            <Col span={24} className="px-2">
                <Space>
                    ...
                    <Space direction="vertical" size={0}>
                        ...
                        <Text className="text-md" type="secondary">email</Text>
                    </Space>
                </Space>
            </Col>
            ...
            <Col span={24} onClick={handleLogout} className="px-2 py-2 rounded-md hover:bg-[#e6f4ff] cursor-pointer transition">
                <Space>
    ...
    return (
        <div className="flex items-center justify-between h-full px-4">
            ...
            <Popover content={popoverContent} placement="bottomLeft" mouseLeaveDelay={0.4}>
